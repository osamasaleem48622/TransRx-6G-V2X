...
class E2ESystem(Model):
    def __init__(self, system, training=False):
        ...
        #####################################
        # Channel
        # A 3GPP UMa channel model is used
...
for i in range(num_training_iterations):
    ...
    with tf.GradientTape() as tape:
        rate, accuracy, bce = model(training_batch_size, ebno_db)
    ...
    if i % 1000 == 0:
        print('Iteration {}/{}  Rate: {} bit, accuracy : {} , BCE : {}'.format(i, num_training_iterations, rate.numpy(), accuracy.numpy(), bce.numpy()))
